...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/pacio-fp/StructureDefinition/event-location']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/pacio-fp/StructureDefinition/event-location': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/pacio-fp/StructureDefinition/assistance-required']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/pacio-fp/StructureDefinition/assistance-required': maximum cardinality of 'extension' is 1</sch:assert>
